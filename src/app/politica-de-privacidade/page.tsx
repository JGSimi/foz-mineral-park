...
import { LegalHero } from "@/components/page-hero";
  ...
  return (
    <>
      <LegalHero
        ...
        title="Política de Privacidade"
        meta={`Última atualização: ${lastUpdate}. Controlador: ${site.company.legalName}, CNPJ ${site.company.cnpj}.`}
      />

      <section className="py-16 sm:py-24">
        <Container size="md">
          <div className="space-y-8 text-sm leading-relaxed text-quartz-700">
            <Block title="1. Quem somos">
              <p>
                {site.company.legalName} ({site.name}) é um parque e museu de
                minerais em Foz do Iguaçu/PR. Esta política explica como
                tratamos os dados pessoais coletados por meio do site{" "}
            ...
            <Block title="2. Dados que tratamos">
              <ul className="list-disc space-y-2 pl-5">
                ...
                <li>
                  <strong>Dados de ingresso</strong> quando efetuar compra:
                  nome, CPF (quando exigido pela fiscalização), e-mail, data
                  escolhida e dados do pagamento (processados pelo gateway
                  escolhido).
                </li>
                <li>
            ...
            <Block title="3. Para que usamos">
              <ul className="list-disc space-y-2 pl-5">
                ...
                <li>
                  Emitir ingresso, voucher e cumprir obrigações fiscais e
                  legais.
                </li>
            ...
            <Block title="4. Bases legais (art. 7º da LGPD)">
              <ul className="list-disc space-y-2 pl-5">
                ...
                <li>
                  <strong>Obrigação legal</strong> para emissão de nota fiscal
                ...
                <li>
                  ...
                  marketing, revogável a qualquer tempo.
                </li>
              </ul>
            </Block>
            ...
            <Block title="5. Compartilhamento">
              ...
              <ul className="list-disc space-y-2 pl-5">
                ...
                <li>
                  ...
                  — processamento da compra de ingressos. Não armazenamos dados
                  do cartão.
                </li>
                <li>
                  <strong>Autoridades</strong> — quando exigido por lei ou
                  ordem judicial.
                </li>
              </ul>
            </Block>
            ...
            <Block title="7. Retenção">
              <p>
                ...
                compra pelo prazo legal exigido pela Receita Federal. Você
                pode, a qualquer momento, pedir a exclusão de dados que não
                estejam sujeitos a retenção obrigatória.
              </p>
            </Block>
            ...
            <Block title="9. Cookies">
              <p>
                ...
                estatísticas agregadas via Vercel Analytics. O banner
                apresentado na sua primeira visita oferece opção para aceitar
                ou recusar.
              </p>
            </Block>
            ...
            <Block title="10. Segurança">
              <p>
                ...
                proteger seus dados: HTTPS forte, headers de segurança
                modernos, controle de acesso, logs de auditoria e rotação

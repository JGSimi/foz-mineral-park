...
Production site for **Foz Mineral Park LTDA** (CNPJ 56.199.013/0001-96) — a mineral museum / theme-park on Av. das Cataratas, Foz do Iguaçu, PR. This codebase was built to **replace** an earlier AI-generated site (diagnosed in `/Users/joaosimi/.Codex/plans/security-audit-fozmineral-deep.md` and `/Users/joaosimi/.Codex/plans/relatorio-cliente-fozmineral.md`) that had no working funnel, zero SEO indexing, and multiple LGPD/CDC violations.
